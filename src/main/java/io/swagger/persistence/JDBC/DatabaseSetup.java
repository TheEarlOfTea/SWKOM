...
public class DatabaseSetup {
    ...
    /*public static void setUp() throws SQLException {
        ...
        try {
            ...
            createTourTable(connection, at.technikum_wien.tourPlanner.dataAccessLayer.database.TableName.REGULAR_TOUR_TABLE_NAME.getName());
            createTourTable(connection, at.technikum_wien.tourPlanner.dataAccessLayer.database.TableName.DEMO_TOUR_TABLE_NAME.getName());
